...
locals {
  ...
  create_cross_account_auth_policy      = var.existing_secrets_manager_crn == null && !var.skip_secrets_manager_kms_iam_authorization_policy && var.ibmcloud_kms_api_key != null
...
module "secrets_manager" {
  ...
  skip_iam_authorization_policy = var.skip_secrets_manager_certificate_engine_iam_authorization_policy
  # kms dependency
  is_hpcs_key                       = local.is_hpcs_key
  kms_encryption_enabled            = var.kms_encryption_enabled
  kms_key_crn                       = local.kms_key_crn
  skip_kms_iam_authorization_policy = var.skip_secrets_manager_kms_iam_authorization_policy || local.create_cross_account_auth_policy
