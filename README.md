...
| <a name="input_endpoint_type"></a> [endpoint\_type](#input\_endpoint\_type) | The type of endpoint to connect your Secrets Manager instance to Event Notifications. Possible values: public, private. The Terraform provider uses this value to configure notifications. | `string` | `"public"` | no |
