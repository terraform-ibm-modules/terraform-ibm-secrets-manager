...
| <a name="input_region"></a> [region](#input\_region) | The region where the resource will be provisioned.Its not required if passing a value for existing\_sm\_instance\_crn | `string` | `null` | no |
